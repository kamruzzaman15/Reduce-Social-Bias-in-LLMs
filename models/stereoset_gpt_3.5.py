...
df1.to_csv('gpt3.5_stereoset_valid_standard_prompt.csv', index=False, encoding='utf-8')
...
df2.to_csv('gpt3.5_stereoset_invalid_standard_prompt.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_CoT.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt3.5_stereoset_invalid_CoT.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_type1.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt_3.5_stereoset_invalid_type1.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_type2.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt_3.5_stereoset_invalid_type2.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_human_type1.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt_3.5_stereoset_invalid_human_type1.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_human_type2.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt_3.5_stereoset_invalid_human_type2.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_human_CoT.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt3.5_stereoset_invalid_human_CoT.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_human_type2_CoT.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt3.5_stereoset_invalid_human_type2_CoT.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_machine_type1.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt3.5_stereoset_invalid_machine_type1.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_machine_type2.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt3.5_stereoset_invalid_machine_type2.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_machine_CoT.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt3.5_stereoset_invalid_machine_CoT.csv', index=False, encoding='utf-8')
...
# GPT-3.5 model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('gpt3.5_stereoset_valid_machine_type2_CoT.csv', index=False, encoding='utf-8')

# GPT-3.5 model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('gpt3.5_stereoset_invalid_machine_type2_CoT.csv', index=False, encoding='utf-8')
