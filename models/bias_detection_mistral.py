...
llm = LlamaCpp(
    model_path="your_mistral_model_path",
    n_gpu_layers = -1,
...
df1.to_csv('mistral_bias_detection_valid_standard_prompt.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_standard_prompt.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_CoT.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_CoT.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_type1.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_type1.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_type2.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_type2.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_human_type1.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_human_type1.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_human_type2.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_human_type2.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_human_CoT.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_human_CoT.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_human_type2_CoT.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_human_type2_CoT.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_machine_type1.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detectiont_invalid_machine_type1.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_machine_type2.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_machine_type2.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_machine_CoT.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_machine_CoT.csv', index=False, encoding='utf-8')
...
# Mistral model responds with a value that matches the three provided options
df1 = pd.DataFrame(framing_data_valid_result)
df1.to_csv('mistral_bias_detection_valid_machine_type2_CoT.csv', index=False, encoding='utf-8')

# Mistral model responds with a value that does not match the three provided options
df2 = pd.DataFrame(framing_data_invalid_result)
df2.to_csv('mistral_bias_detection_invalid_machine_type2_CoT.csv', index=False, encoding='utf-8')
